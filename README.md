...
Este repositorio contiene mis investigaciones, análisis forenses y ejercicios prácticos realizados durante mi formación en Ciberseguridad, con especialización en DFIR.
...
- Análisis de discos (Autopsy, TSK, FTK Imager)
- Interpretación de artefactos de Windows
- Timeline forensics
- Análisis básico de malware
- Respuesta a incidentes (DFIR)
- Redacción de informes profesionales

Este portfolio está construido únicamente con materiales de laboratorio y retos públicos.
